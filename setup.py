...
setup(
    ...
    description="Reinforcement learning environment for spiking neural networks",  # Optional
    ...
    url="https://github.com/ncskth/norse-rl",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Jens E. Pedersen",  # Optional
