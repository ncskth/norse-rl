...
class CartpoleEnv(gym.Env):
    ...
    def render(self, canvas):
        ...
        canvas.stroke_line(0, carty, 400, carty)
        # Draw cart
        canvas.save()
        canvas.translate(*self.carttrans)
        canvas.begin_path()
        canvas.move_to(l, b)
        for x, y in [(l, t), (r, t), (r, b)]:
            canvas.line_to(x, y)
        ...
        canvas.rotate(self.poletrans + math.pi)
        canvas.begin_path()
        canvas.move_to(l, b)
        for x, y in [(l, t), (r, t), (r, b)]:
            canvas.line_to(x, y)
        canvas.fill_style = "rgb(200, 140, 80)"
        canvas.fill()
        canvas.restore()
